                ...
                <div className='flex items-center justify-center md:justify-center gap-5 w-full mt-4'>
                    <div className='flex items-center justify-start gap-2 text-[12px]'>
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" className="iconify iconify--accent size-5 sm:size-6" width="1em" height="1em" viewBox="0 0 24 24"><g fill="none"><path d="M17 10H19C21 10 22 9 22 7V5C22 3 21 2 19 2H17C15 2 14 3 14 5V7C14 9 15 10 17 10Z" stroke="currentColor" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <path d="M18 22C20.2091 22 22 20.2091 22 18C22 15.7909 20.2091 14 18 14C15.7909 14 14 15.7909 14 18C14 20.2091 15.7909 22 18 22Z" stroke="#1EB35B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
                    ...
                    <div className='flex items-center justify-start gap-2 text-[12px]'>
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" className="iconify iconify--accent size-5 sm:size-6" width="1.05em" height="1em" viewBox="0 0 25 24" ><g fill="none"><path d="M22.5 16.74V4.67001C22.5 3.47001 21.52 2.58001 20.33 2.68001H20.27C18.17 2.86001 14.98 3.93001 13.2 5.05001L13.03 5.16001C12.74 5.34001 12.26 5.34001 11.97 5.16001L11.72 5.01001C9.94 3.90001 6.76 2.84001 4.66 2.67001C3.47 2.57001 2.5 3.47001 2.5 4.66001V16.74C2.5 17.7 3.28 18.6 4.24 18.72L4.53 18.76C6.7 19.05 10.05 20.15 11.97 21.2L12.01 21.22C12.28 21.37 12.71 21.37 12.97 21.22C14.89 20.16 18.25 19.05 20.43 18.76L20.76 18.72C21.72 18.6 22.5 17.7 22.5 16.74Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M12.5 5.49001V20.49" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M8.25 8.49001H6" stroke="#1EB35B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M9 11.49H6" stroke="#1EB35B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
                        <span>آموزش ویژه بازار کار</span>
                    </div>
                    <div className='flex items-center justify-start gap-2 text-[12px]'>
                        <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" className="iconify iconify--accent size-5 sm:size-6" width="1em" height="1em" viewBox="0 0 24 24" ><g fill="none"><path d="M12.0001 7.89001L10.9301 9.75001C10.6901 10.16 10.8901 10.5 11.3601 10.5H12.6301C13.1101 10.5 13.3001 10.84 13.0601 11.25L12.0001 13.11" stroke="#1EB35B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            ...
                            <path d="M8.5 22C10.79 21.35 13.21 21.35 15.5 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>
